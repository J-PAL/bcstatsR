...
## Need help?
Check out all the features of `bcstats` in the help page and post an [issue on GitHub](https://github.com/J-PAL/bcstatsR/issues) if you encounter any problems.
```{r}
help(bcstats)
```
